...
| Full path | Why |
|---|---|
| `D:\Projects\store\backend\docs\map\INCOMING.md` | What routes exist, section numbers, current `[ ]`/`[~]`/`[x]` status |
| `D:\Projects\store\backend\docs\map\CHECKLIST.md` | What is already production-ready — do not re-implement these |
...
|---|---|
| `D:\Projects\store\backend\docs\prompts\PROMPT-TEMPLATE.md` | Every stage — contains the exact prompt structure to fill in |
| `D:\Projects\store\backend\docs\RULES.md` | Every stage — global naming, error wrapping, comment style |
| `D:\Projects\store\backend\docs\rules\auth.md` | Auth domain routes — guard ordering, OTP patterns, ADRs |
| `D:\Projects\store\backend\docs\skills\backend-route-impl\references\route-map.md` | Every stage — resolved Go package paths for all routes |
...
```
D:\Projects\store\backend\internal\domain\{domain}\{route}\service.go
D:\Projects\store\backend\internal\domain\{domain}\{route}\handler.go
D:\Projects\store\backend\internal\domain\{domain}\{route}\routes.go
D:\Projects\store\backend\internal\domain\{domain}\shared\errors.go
D:\Projects\store\backend\internal\domain\{domain}\shared\models.go
D:\Projects\store\backend\internal\audit\audit.go
D:\Projects\store\backend\sql\queries\{domain}.sql
```
...
SQL queries:         sql/queries/auth.sql  (or admin.sql)
