...
// ListPermissions handles GET /admin/users/{user_id}/permissions.
...
// GrantPermission handles POST /admin/users/{user_id}/permissions.
...
// RevokePermission handles DELETE /admin/users/{user_id}/permissions/{grant_id}.
...
func (h *Handler) writeGrantError(w http.ResponseWriter, r *http.Request, err error) {
	...
	case errors.Is(err, adminshared.ErrScopeNotAllowed):
