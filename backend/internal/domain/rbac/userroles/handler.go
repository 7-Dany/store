...
// GetUserRole handles GET /admin/rbac/users/{user_id}/role.
...
// AssignRole handles PUT /admin/rbac/users/{user_id}/role.
...
// RemoveRole handles DELETE /admin/rbac/users/{user_id}/role.
