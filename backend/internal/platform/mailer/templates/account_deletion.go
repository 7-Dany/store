  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f3f4;padding:48px 0;">
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0"
        ...
        <!-- red top accent for destructive action -->
        <tr><td style="height:4px;background:#d93025;font-size:0;line-height:0;">&nbsp;</td></tr>
        ...
        <tr><td style="padding:24px 48px 0;">
          <p style="margin:0 0 6px;font-size:20px;font-weight:600;color:#202124;">Confirm account deletion</p>
          <p style="margin:0;font-size:14px;color:#5f6368;line-height:1.6;">
            You requested to permanently delete your <strong style="color:#202124;">{{.AppName}}</strong> account.
            Use the confirmation code below to complete this request.
        ...
        <tr><td align="center" style="padding:28px 48px;">
          <table cellpadding="0" cellspacing="0">
            <tr>
              <td style="background:#fce8e6;border-radius:8px;padding:18px 36px;text-align:center;">
                <span style="font-size:34px;font-weight:700;letter-spacing:12px;color:#d93025;font-family:monospace;">{{.Code}}</span>
              </td>
            </tr>
          </table>
        </td></tr>
        ...
        <tr><td style="padding:0 48px 32px;">
          <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td style="background:#fafafa;border-left:3px solid #d93025;border-radius:0 4px 4px 0;padding:12px 16px;">
                <p style="margin:0;font-size:12px;color:#5f6368;line-height:1.6;">
                  <strong style="color:#202124;">This action is irreversible.</strong>
                  If you did not request account deletion, you can ignore this email &mdash;
