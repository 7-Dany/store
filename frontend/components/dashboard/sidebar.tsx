  ...
  return (
    <SidebarMenu>
      <SidebarMenuItem>
        <DropdownMenu>
          {/*
           * Use render= (base-ui pattern) instead of asChild so that
           * Menu.Trigger merges its props into SidebarMenuButton directly,
           * avoiding the button-in-button nesting error.
           */}
          <DropdownMenuTrigger
            render={
              <SidebarMenuButton
          ...
          <DropdownMenuContent
            ...
            sideOffset={4}
          >
            {/* User info header — plain div label, no Menu.Group required */}
...
export function AppSidebar({ user }: { user: UserProfile | null }) {
  const pathname = usePathname();

  return (
    <Sidebar collapsible="icon">
      {/* Logo header — render= on SidebarMenuButton, no asChild */}
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
      ...
      {/* Nav — render= on each SidebarMenuButton for Link routing */}
      <SidebarContent>
        <SidebarGroup>
